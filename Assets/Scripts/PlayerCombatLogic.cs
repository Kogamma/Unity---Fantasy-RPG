...
public class PlayerCombatLogic : MonoBehaviour {
    ...
    public GameObject playerComabat;                            //Using this to set the diffrent camera states
    ...
    int noteSpeed;                                              //Using to set the notespeed for the attacks
    ...
    public void MeeleAttack()
    {
        ...
        noteSpeed = 150;    //The speed for the notes will be 150
    ...
    public void IceAttack()
    {
        ...
        noteSpeed = 200;    //The speed for the notes will be 200
    ...
    {
        playerComabat.GetComponent<CombatScript>().ChangeViewPort(CombatScript.cameraState.ENEMY); //Chaning the camerstate to Enemy!
    }
